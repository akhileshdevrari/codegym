...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" style="background-color: #0E1935">
    <span class="navbar-brand">Hey <a href="index.html" class="name">Profile</a></span>
  ...
  <div class="contest-form">
    <div class="row">
      <div class="container">
        <div>
          <div class="form-area">  
            <form role="form" action="contest.php" method="post">
              <h2 style="text-align: center;">Contest Form</h2>
              <div class="field">
              Duration of Contest:
